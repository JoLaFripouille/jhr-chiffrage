...
QTabWidget#mainNavigation > QTabBar::tab { background: transparent; color: #66768e; padding: 8px 22px; margin-right: 4px; border-bottom: 3px solid transparent; }
...
QLineEdit#estimateName { background: transparent; border: 1px solid transparent; color: #1d3354; font-size: 20px; font-weight: 600; padding: 2px 0px; }
...
QTreeWidget::item { border-bottom: 1px solid #edf1f6; padding: 4px 7px; }
QTreeWidget::item:selected { background: #e8f1ff; color: #204d91; }
QHeaderView::section { background: #f5f8fc; color: #71829a; border: none; border-bottom: 1px solid #e4ebf4; padding: 6px 7px; font-size: 11px; font-weight: 600; }
...
QLabel#metricValue { color: #243d60; font-size: 18px; font-weight: 600; }
